	...
	<tr>
		...
		<td id="page">
			...
			<form action="edit_subject.php?subj=<?php echo urlencode($sel_subject['id']); ?>" method="post">
				...
				<a href="delete_subject.php?subj=<?php echo urlencode($sel_subject['id']); ?> "  onclick="return confirm('Are you sure you waant to delete this subject');">Delete Subject </a>
			</form>
			<br />
